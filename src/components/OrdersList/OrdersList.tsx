...
const OrdersList: FC<IOrdersList> = ({type}) => {
    const navigate = useNavigate();

    const handleOrderClick = () => {
        type === 'feed' ? navigate('/feed/123131') : navigate('/profile/123131');
    };
        ...
        <div className={styles.orders__card__container}>
            <div className={styles.orders__card} onClick={handleOrderClick}>
                ...
                <div className={`${styles.orders__title} ${styles.type}`}>
                    <h2 className={`text text_type_main-medium ${type === 'profile' ? 'mb-2': ''}`}>Death Star Starship Main бургер</h2>
            ...
            </div><div className={styles.orders__card} onClick={handleOrderClick}>
                <div className={`${styles.orders__info}`}>
                    <h3 className="text text_type_digits-default">#034535</h3>
                    <p className="text text_type_main-default text_color_inactive">Сегодня, 16:20 i-GMT+3</p>
                </div>
